        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          <AnimatePresence mode='popLayout'>
            {filteredDishes.map((dish, index) => (
              ...
              >
                <GlassCard className={`h-full flex flex-col overflow-hidden group border-white/5 hover:border-orange-500/30 transition-all ${dish.isDeal ? 'ring-1 ring-orange-500/20' : ''}`}>
                  <div className="relative h-56 sm:h-64 w-full overflow-hidden">
                    {dish.isDeal && (
                      <div className="absolute top-4 left-4 z-30 bg-orange-500 text-white px-3 py-1 rounded-full flex items-center gap-1 shadow-xl">
                  ...
                  <div className="p-6 flex-grow flex flex-col bg-zinc-950/40">
                    ...
                    <div className="mt-auto">
                      ...
                      <div className="flex gap-3">
                        ...
                        <button 
                          className="flex-1 h-12 rounded-full bg-orange-500 text-white text-[10px] font-black uppercase tracking-[0.2em] hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-2 shadow-lg shadow-orange-500/20"
                          onClick={() => {
                            addToCart({
                              id: dish.id.toString(),
                              name: dish.name,
                              ...
                              portionInfo: '',
                              // Fixed: This is now the object TypeScript expects
                              selectedSize: {
                                size: 'Standard',
                                price: parseFloat(dish.price),
                                portionInfo: 'Standard Portion'
                              }
                            });
                          }}
                        >
